...
<head>
    ...
    <title>Tambah Kategori - PT. Ujug-Ujug</title>
        ...
        <nav class="border-b border-slate-200/80 bg-white/70 backdrop-blur-md">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <span class="text-slate-300">/</span>
                    <span class="text-sm font-medium text-slate-900">Tambah</span>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-soft border border-slate-100 p-6">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-500">Buat klasifikasi baru untuk mengelompokkan tiket.</p>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="{{ route('admin.categories.store') }}" class="space-y-5">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3"
                                class="w-full rounded-xl border-slate-300 bg-white shadow-sm focus:border-brand-500 focus:ring-brand-500/20 transition-all"
                                placeholder="Penjelasan singkat kegunaan kategori ini...">{{ old('description') }}</textarea>
                        ...
                        <div class="flex items-center justify-end gap-3 pt-2">
                            ...
                            <button type="submit" class="btn-primary text-white px-5 py-2.5 rounded-xl text-sm font-medium">Simpan Kategori</button>
                        </div>
                    </form>
                </div>
            </div>
