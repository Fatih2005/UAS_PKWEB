...
<head>
    ...
    <title>Register - PT. Ujug-Ujug</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div class="mt-20 mb-10 text-center">
                <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-50 text-brand-700 text-xs font-medium ring-1 ring-brand-600/10 mb-4">
                    ...
                    Bergabung dengan Ticketing System
                </div>
                <h1 class="text-3xl font-bold text-slate-900">Buat akun baru</h1>
                <p class="text-slate-500 mt-2">Daftarkan akun untuk mulai mengelola tiket</p>
            </div>
                ...
                <div class="glass rounded-2xl shadow-soft border border-white/60 p-8">
                    ...
                    <form action="/register" method="POST" class="space-y-5">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500 mt-1.5">Gunakan kombinasi huruf, angka, dan simbol untuk keamanan.</p>
                        </div>
                        <div>
                    ...
                    <div class="mt-6 pt-6 border-t border-slate-200 text-center text-sm text-slate-600">
                        Sudah punya akun?
                        <a href="/login" class="text-brand-600 hover:text-brand-700 font-medium ml-1">Masuk di sini</a>
                    </div>
                </div>
            </div>
        </div>
